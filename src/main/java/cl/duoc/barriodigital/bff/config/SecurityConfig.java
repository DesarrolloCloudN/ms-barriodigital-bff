...
// Configura la seguridad del BFF: validacion del JWT, rutas publicas y CORS.
@Configuration
...
public class SecurityConfig {
    ...
    // Decodifica el JWT y valida issuer, expiracion y audiencia en conjunto.
    @Bean
    ...
    // Rutas publicas quedan fuera del login; el resto exige JWT con roles mapeados.
    @Bean
